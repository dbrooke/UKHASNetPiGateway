...
static const uint8_t CONFIG[][2] =
{
    ...
    { RFM69_REG_29_RSSI_THRESHOLD, 180 }, // -90dBm is closer to actual conditions
    ...
    { RFM69_REG_6F_TEST_DAGC, RF_DAGC_IMPROVED_LOWBETA1 }, // run DAGC continuously in RX mode, recommended default for AfcLowBetaOn=0
